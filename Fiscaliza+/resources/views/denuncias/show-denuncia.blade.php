...
@section('title', 'Fiscaliza+ | visualizar Denúncia')
...
<div class="max-w-3xl mx-auto px-4 space-y-8 py-8">
    ...
    <div x-data="{ commentsOpen: true }" class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6 space-y-4 transition-shadow duration-300 hover:shadow-xl">
