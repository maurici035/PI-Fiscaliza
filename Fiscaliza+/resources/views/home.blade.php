...
<body>
  ...
  <header class="top-header">
    <div>
      <img src="{{ asset('assets/fiscaliza+-name.png') }}" alt="Fiscaliza+" class="brand-logo" />
    </div>
    <div class="header-right">
      ...
      <div class="user-avatar">
        <img src="{{ asset('assets/Captura_de_tela_2025-04-09_151332-removebg-preview.png') }}" alt="User profile" />
      </div>
    </div>
  </header>
    ...
    <div class="report-card">
      <div class="report-input">
        <div class="input-avatar">
          <img src="{{ asset('assets/Captura_de_tela_2025-04-09_151332-removebg-preview.png') }}" alt="User avatar" />
        </div>
      ...
      <div class="modal-dialog">
        <form id="formComentario" class="modal-content">
          ...
          <div class="modal-body">
            <textarea class="form-control" id="inputComentario" rows="4" placeholder="Digite seu comentário aqui..."></textarea>
          </div>
          <div class="modal-footer">
