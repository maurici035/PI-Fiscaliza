...
<head>
  ...
  <link rel="stylesheet" href="../../public/css/feedback-orgao.css">
...
<body>
  ...
  <div class="main-content">  
    <div class="assiduidade-container">
      ...
      <div class="orgao-list" id="orgaoList">
        <div class="orgao-item" data-category="obras" data-rating="4.2" data-response="3" data-name="Secretaria Municipal de Obras e Infraestrutura-RJ">
          <div class="orgao-info">
            <h3>Secretaria Municipal de Obras e Infraestrutura-RJ</h3>
            <button class="btn-details" onclick="showDetails('Secretaria Municipal de Obras e Infraestrutura-RJ')">Ver Detalhes</button>
          </div>
          <div class="orgao-metrics">
            ...
            <button class="btn-avaliar" onclick="openRatingModal('Secretaria Municipal de Obras e Infraestrutura-RJ')">Avaliar</button>
          </div>
        ...
        <div class="orgao-item" data-category="meio-ambiente" data-rating="3.5" data-response="5" data-name="Secretaria Municipal do Meio Ambiente-RS">
          <div class="orgao-info">
            <h3>Secretaria Municipal do Meio Ambiente-RS</h3>
            <button class="btn-details" onclick="showDetails('Secretaria Municipal do Meio Ambiente-RS')">Ver Detalhes</button>
          </div>
          <div class="orgao-metrics">
            <div class="rating">
              <span class="star filled">★</span>
            ...
            <button class="btn-avaliar" onclick="openRatingModal('Secretaria Municipal do Meio Ambiente-RS')">Avaliar</button>
          </div>
          <div class="orgao-response">
        ...
        <div class="orgao-item" data-category="transito" data-rating="3.2" data-response="7" data-name="Secretaria Municipal de Trânsito e Transportes-BA">
          <div class="orgao-info">
            <h3>Secretaria Municipal de Trânsito e Transportes-BA</h3>
            <button class="btn-details" onclick="showDetails('Secretaria Municipal de Trânsito e Transportes-BA')">Ver Detalhes</button>
          </div>
          <div class="orgao-metrics">
            <div class="rating">
              <span class="star filled">★</span>
            ...
            <button class="btn-avaliar" onclick="openRatingModal('Secretaria Municipal de Trânsito e Transportes-BA')">Avaliar</button>
          </div>
          <div class="orgao-response">
  ...
  <script src="../../public/js/feedback-orgao.js"></script>
</body>
</html>