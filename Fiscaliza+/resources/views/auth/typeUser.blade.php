  ...
  <div class="login-container z-10 w-full max-w-md">
    <div class="login-box bg-white rounded-2xl overflow-hidden relative shadow-lg">
      ...
      <div class="pt-16 px-8 pb-8">
        ...
        <h2 class="text-2xl font-bold text-center text-dark mb-6">Escolha como quer ser cadastrar</h2>

        <a href="{{route('cadastro')}}" class="w-full py-3 bg-primary text-white font-semibold rounded-xl flex items-center justify-center mt-2">
            Se cadastrar como pessoa
        </a>
        <a href="{{route('empresa.cadastro')}}" class="w-full py-3 bg-primary text-white font-semibold rounded-xl flex items-center justify-center mt-2">
            se cadastrar como empresa
        </a>

      <div class="bg-gray-50 px-8 py-4 text-center border-t border-gray-100">
        <p class="text-gray-600 text-sm">
          Já possui uma conta?
          <a href="{{route('login')}}" class="text-primary font-medium hover:text-secondary transition">Fazer login</a>
        </p>
      </div>
    </div>
