  ...
  <div class="login-container z-10 w-full max-w-md">
    <div class="login-box bg-white rounded-2xl overflow-hidden relative shadow-lg">
      ...
      <div class="pt-16 px-8 pb-8">
        ...
        <!-- FORMULÁRIO -->
        <form method="POST" action="{{ route('empresa.login.post') }}">
          @csrf
          <div class="space-y-4">
            <!-- Email -->
            <div class="relative">
      ...
      <div class="bg-gray-50 px-8 py-4 text-center border-t border-gray-100">
        <p class="text-gray-600 text-sm">
          ...
          <a href="{{route('empresa.cadastro')}}" class="text-primary font-medium hover:text-secondary transition">Cadastrar</a>
        </p>
      </div>
    </div>
